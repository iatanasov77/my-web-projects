(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["js/pages/projects"],{
  ...
  $('#install-manual-modal').on('click', '#btnEditInstallManual', function (e) {
    ...
    $.ajax({
      ...
      success: function success(response) {
        ...
        $('#installManual > div.card-body').html(response); //$( '#install-manual-modal' ).modal( 'toggle' );
      },
      error: function error() {
        $("#projectSpinner").remove();
        alert("SYSTEM ERROR!!!");
      ...
      success: function success(response) {
        ...
        if (response.status == 'error') {
          ...
          $.each(response.errors, function (key, value) {
            ul.append($(document.createElement('li')).text(key + ': ' + value));
          });
