...
INSERT INTO `projects` (`id`, `category_id`, `name`, `description`, `source_type`, `repository`, `branch`, `project_root`, `document_root`, `host`, `with_ssl`, `install_manual`, `phpFpmSocket`, `reverseProxy`, `predefinedType`, `predefinedTypeParams`) VALUES
(1, 2, 'SalaryJ2', NULL, 'git', 'https://gitlab.com/iatanasov77/salary-j-2', 'master', '/projects/SalaryJ2', '/projects/SalaryJ2/public', 'salaryj2.lh', '0', 'NO INSTALL MANUAL', NULL, NULL, NULL, NULL),
(2, 3, 'SULU', NULL, NULL, 'https://github.com/sulu/skeleton', 'master', '/projects/SULU', '/projects/SULU/public', 'sulu.lh', '0', 'READ <a href=\"http://docs.sulu.io/en/latest/book/getting-started.html\" target=\"__blank\">THIS</a>', NULL, NULL, NULL, NULL),
(3, 3, 'Magento', NULL, NULL, 'NO', 'NO', '/projects/Magento', '/projects/Magento/public', 'magento.lh', '0', '<p><a href=\"https://devdocs.magento.com/guides/v2.3/install-gde/composer.html\" target=\"__blank\">Install Magento 2.3 with Composer</a></p>', NULL, NULL, NULL, NULL),
(5, 3, 'Sylius', NULL, NULL, 'none', 'none', '/projects/Sylius', '/projects/Sylius/public', 'sylius.lh', '0', '<p><a href=\"https://docs.sylius.com/en/1.6/getting-started-with-sylius/installation.html\" target=\"__blank\">Read Installation Manual</a> Version: 1.6</p>', NULL, NULL, NULL, NULL),
(6, 4, 'VankoSoft.Org', NULL, NULL, 'https://gitlab.com/iatanasov77/vankosoft.org.git', 'develop', '/projects/VankoSoft.Org', '/projects/VankoSoft.Org/public', 'vankosoft.lh', '0', NULL, NULL, NULL, NULL, NULL),
(7, 4, 'BabyMarket 2', NULL, NULL, 'https://gitlab.com/iatanasov77/babymarket.bg_2.git', 'develop', '/projects/BabyMarket_2', '/projects/BabyMarket_2/public', 'babymarket2.lh', '0', NULL, NULL, NULL, NULL, NULL),
(8, 2, 'Okta_AspNetCoreMysql', NULL, 'git', 'https://github.com/oktadeveloper/okta-aspnetcore-mysql-twilio-example.git', 'master', '/projects/Okta_AspNetCoreMysql', '/projects/Okta_AspNetCoreMysql/TextTasks/wwwroot', 'oam.lh', '0', NULL, NULL, NULL, NULL, NULL);
