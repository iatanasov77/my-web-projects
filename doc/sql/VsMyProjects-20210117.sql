...
--
-- Host: localhost
-- Generation Time: Jan 17, 2021 at 04:58 PM
...
INSERT INTO `projects` (`id`, `category_id`, `name`, `description`, `source_type`, `repository`, `branch`, `project_root`, `install_manual`, `predefinedType`, `predefinedTypeParams`) VALUES
(1, 2, 'SalaryJ2', NULL, 'git', 'https://gitlab.com/iatanasov77/salary-j-2', 'master', '/projects/SalaryJ2', 'NO INSTALL MANUAL', NULL, NULL),
(2, 3, 'SULU', NULL, NULL, 'https://github.com/sulu/skeleton', 'master', '/projects/SULU', 'READ <a href=\"http://docs.sulu.io/en/latest/book/getting-started.html\" target=\"__blank\">THIS</a>', NULL, NULL),
(3, 3, 'Magento', NULL, NULL, 'NO', 'NO', '/projects/Magento', '<p><a href=\"https://devdocs.magento.com/guides/v2.3/install-gde/composer.html\" target=\"__blank\">Install Magento 2.3 with Composer</a></p>', NULL, NULL),
(5, 3, 'Sylius', NULL, NULL, 'none', 'none', '/projects/Sylius', '<p><a href=\"https://docs.sylius.com/en/1.6/getting-started-with-sylius/installation.html\" target=\"__blank\">Read Installation Manual</a> Version: 1.6</p>', NULL, NULL),
(6, 4, 'VankoSoft.Org', NULL, NULL, 'https://gitlab.com/iatanasov77/vankosoft.org.git', 'develop', '/projects/VankoSoft.Org', NULL, NULL, NULL),
(7, 4, 'BabyMarket 2', NULL, NULL, 'https://gitlab.com/iatanasov77/babymarket.bg_2.git', 'develop', '/projects/BabyMarket_2', NULL, NULL, NULL),
(8, 2, 'Okta_AspNetCoreMysql', NULL, 'git', 'https://github.com/oktadeveloper/okta-aspnetcore-mysql-twilio-example.git', 'master', '/projects/Okta_AspNetCoreMysql', NULL, NULL, NULL);
...
CREATE TABLE `projects_hosts` (
  ...
  `phpVersion` varchar(32) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `reverseProxy` varchar(128) DEFAULT NULL,
...
INSERT INTO `projects_hosts` (`id`, `project_id`, `host_type`, `host`, `document_root`, `phpVersion`, `reverseProxy`, `with_ssl`) VALUES
(1, 1, 'Lamp', 'junona.lh', '/projects-myspace/Test', 'default', NULL, 0);
